...
describe('CypressCustomIconComponent', () => {
...
@Component({
  template: ` <rc-cypress-custom-icon
    [width]="width"
    [height]="height"
  ></rc-cypress-custom-icon>`,
})
class HostComponent {
  public width!: CypressCustomIconComponent['width'];
  public height!: CypressCustomIconComponent['height'];
}
